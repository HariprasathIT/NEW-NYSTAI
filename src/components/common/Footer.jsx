...
const NystaiFooter = () => {
  return (
    <>
      <footer className="w-full bg-[#f5f5f5]" style={{ borderRadius: "30px 30px 0px 0px" }}>
        <div className="mx-auto max-w-[1540px] px-4 sm:px-6 lg:px-8">
          {/* Main Footer Content */}
          <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8 py-8 sm:py-10">

            {/* Brand Section */}
            <div className="col-span-1 xs:col-span-2 md:col-span-3 lg:col-span-1 text-center lg:text-left mx-auto lg:mx-0 max-w-xs lg:max-w-none">
              <img src={nyslogo} alt="Company Logo" className="h-[60px] mx-auto lg:mx-0" />
            ...
            {/* Subscribe Section */}
            <div className="col-span-1 xs:col-span-2 md:col-span-3 lg:col-span-1 text-center lg:text-left mx-auto lg:mx-0 max-w-xs lg:max-w-none">
              <h4 className="text-lg text-gray-900 font-medium mb-4 sm:mb-7">Subscribe</h4>
          ...
          <div className="py-6 sm:py-7 border-t border-gray-200">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
              ...
              <div className="flex gap-3 sm:gap-4">
                <a
                  href="#"
                  className="w-9 h-9 sm:w-10 sm:h-10 rounded-full transition-all duration-500 flex justify-center items-center bg-[#33CCFF] hover:bg-gray-900"
                  aria-label="Twitter"
                >
                ...
                <a
                  href="#"
                  className="w-9 h-9 sm:w-10 sm:h-10 rounded-full transition-all duration-500 flex justify-center items-center bg-gradient-to-br from-purple-600 via-pink-600 to-orange-400 hover:opacity-80"
                ...
                <a
                  href="#"
                  className="w-9 h-9 sm:w-10 sm:h-10 rounded-full transition-all duration-500 flex justify-center items-center bg-[#337FFF] hover:bg-gray-900"
                  aria-label="Facebook"
                >
                  <svg className="w-4 h-5 text-white" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a
                  href="#"
                  className="w-9 h-9 sm:w-10 sm:h-10 rounded-full transition-all duration-500 flex justify-center items-center bg-[#FF0000] hover:bg-gray-900"
                  aria-label="YouTube"
                >
